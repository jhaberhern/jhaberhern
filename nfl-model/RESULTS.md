...
- **Features:** elo_diff, rest_diff, div_game, margin_diff, home_qb_new, away_qb_new
- **elo_k:** 16, **mov:** True, **model:** logreg, **C:** 0.1
- **Validation Brier** (seasons 2019-2023): 0.2239
- **Test Brier** (seasons 2024-2025): 0.2143 on 569 games (65.7% accuracy)
- **Vegas moneyline on the same test games:** 0.2059 — gap to close: +0.0084
